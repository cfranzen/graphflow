...
public class DefaultRoutePainter implements IRoutePainter {
	 ...
	 *            the track
	 */
	public DefaultRoutePainter(List<Edge> track) {
	 ...
	 * 
	 */
	public DefaultRoutePainter() {
		// TODO Auto-generated constructor stub
	}

	/* (non-Javadoc)
	 * @see gui.IRoutePainter#setRoute(java.util.List)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see gui.IRoutePainter#paint(java.awt.Graphics2D, org.jxmapviewer.JXMapViewer, int, int)
	 */
	@Override
